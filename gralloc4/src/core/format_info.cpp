                          ...
                          android_dataspace_t *dataspace)
{
	...
	*dataspace = HAL_DATASPACE_UNKNOWN;
	...
	if (formats[format_idx].is_yuv)
	{
		...
		else if ((width <= 768 && height <= 480) || (height <= 768 && width <= 480))
		{
