...
enum {
    ...
    /* 8/10-bit contiguous(single fd) custom formats configured in SBWC formats */
    HAL_PIXEL_FORMAT_EXYNOS_420_SPN_SBWC_DECOMP = 0x129,  /* similar as HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SPN */
    HAL_PIXEL_FORMAT_EXYNOS_P010_N_SBWC_DECOMP  = 0x12A,  /* similar as HAL_PIXEL_FORMAT_YCBCR_P010 */
    ...
    /* SBWC 256B formats */
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SPN_256_SBWC  = 0x136,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SPN_10B_256_SBWC  = 0x137,
    ...
    /* SBWC Lossy v2.7 formats 32/64 align*/
