...
#define MIXER_CARD                 0
#define OFFLOAD_RVB_PARAM_CTL_NAME "Offload RVB param data"
#define OFFLOAD_RVB_PARAM_MAX      10
#define OFFLOAD_RVB_CTX_CTL_NAME   "Offload RVB ctx data"
#define OFFLOAD_RVB_CTX_MAX        7
