...
/* Values */
#define EXIF_DEF_MAKER          "samsung"   /* testJpegExif on the CTS test. This should match Build.MANUFACTURER  */
...
/* This function is used only for HWFC. Dummy function */
static inline bool UpdateDebugData(char *jpeg, size_t jpeglen, debug_attribute_t *debug)
{
    return true;
}

static inline bool UpdateExif(char *jpeg, size_t jpeglen, exif_attribute_t *exif)
{
    return true;
}
