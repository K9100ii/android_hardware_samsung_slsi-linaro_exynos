...
#define LOG_TAG "ExynosDngCreatorForCamera"

#include <utils/Log.h>

#include "ExynosCameraParameters.h"
#include "ExynosDngCreatorForCamera.h"

namespace android {

#ifdef SAMSUNG_DNG

ExynosDngCreatorForCamera::ExynosDngCreatorForCamera()
{
}
...
int ExynosDngCreatorForCamera::makeDng(ExynosCameraParameters *param,
                                char* dngBuffer,
...
int ExynosDngCreatorForCamera::makeDngHeader (unsigned char *dngHeaderOut,
                              dng_attribute_t *dngInfo,
                              unsigned int *size,
                              bool useMainbufForThumb)
{
    unsigned char *pCur, *pIfdStart;
    unsigned int numIFD, LongerTagOffest = 0;
    ...
    LongerTagOffest += 8 + NUM_SIZE + numIFD * IFD_SIZE + OFFSET_SIZE;
    ...
    unsigned char endOfIFD0[4] = { 0x00, 0x00, 0x00, 0x00 };
    memcpy(pCur, endOfIFD0, 4);
    pCur += 4;
...
*/
inline void ExynosDngCreatorForCamera::setStripOffset(unsigned char **pCur,
                                             unsigned short tag,
                                             unsigned short type,
                                             unsigned int count,
                                             unsigned int value,
...
inline void ExynosDngCreatorForCamera::setStripByteCount(unsigned char **pCur,
                                             unsigned short tag,
                                             unsigned short type,
                                             unsigned int count,
                                             unsigned int value,
...
inline void ExynosDngCreatorForCamera::writeTiffIfd(unsigned char **pCur,
                                             unsigned short tag,
                                             unsigned short type,
                                             unsigned int count,
                                             unsigned int value)
