...
static int VIDEO_SIZE_LUT_IMX240_2P2_8MP_FULL[][SIZE_OF_LUT] =
{
    ...
    { SIZE_RATIO_4_3,
     (3984 + 16),(2988 + 12),   /* [sensor ] */
      4000      , 3000      ,   /* [bns    ] */
      3984      , 2988      ,   /* [bcrop  ] */
      2880      , 2160      ,   /* [bds    ] *//* (2880x2160) special handling in ExynosCameraParameters class */
      2880      , 2160      ,   /* [target ] */
    },
    /* 1:1 (Single, Dual) */
    { SIZE_RATIO_1_1,
     (2992 + 16),(2988 + 12),   /* [sensor ] */
      3008      , 3000      ,   /* [bns    ] */
      2976      , 2976      ,   /* [bcrop  ] */
      2160      , 2160      ,   /* [bds    ] *//* (2160x2160) special handling in ExynosCameraParameters class */
      2160      , 2160      ,   /* [target ] */
    },
    /* 3:2 (Single) */
    { SIZE_RATIO_3_2,
     (5312 + 16),(2988 + 12),   /* [sensor ] */
      5328      , 3000      ,   /* [bns    ] */
      4472      , 2988      ,   /* [bcrop  ] */
      3232      , 2160      ,   /* [bds    ] *//* (3232x2160) special handling in ExynosCameraParameters class */
      3232      , 2160      ,   /* [target ] */
    },
    /* 5:4 (Single) */
    { SIZE_RATIO_5_4,
     (3984 + 16),(2988 + 12),   /* [sensor ] */
      4000      , 3000      ,   /* [bns    ] */
      3740      , 2988      ,   /* [bcrop  ] */
      2704      , 2160      ,   /* [bds    ] *//* (2704x2160) special handling in ExynosCameraParameters class */
      2704      , 2160      ,   /* [target ] */
    },
    /* 5:3 (Single) */
    { SIZE_RATIO_5_3,
     (5312 + 16),(2988 + 12),   /* [sensor ] */
      5328      , 3000      ,   /* [bns    ] */
      4976      , 2988      ,   /* [bcrop  ] */
      3600      , 2160      ,   /* [bds    ] *//* (3600x2160) special handling in ExynosCameraParameters class */
      3600      , 2160      ,   /* [target ] */
    },
    /* 11:9 (Single) */
    { SIZE_RATIO_11_9,
     (3984 + 16),(2988 + 12),   /* [sensor ] */
      4000      , 3000      ,   /* [bns    ] */
      3648      , 2988      ,   /* [bcrop  ] */
      2640      , 2160      ,   /* [bds    ] *//* (2640x2160) special handling in ExynosCameraParameters class */
      2640      , 2160      ,   /* [target ] */
    }
};
#endif
...
static int LIVE_BROADCAST_SIZE_LUT_IMX240_2P2_BNS[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
#endif
#if defined(ENABLE_8MP_FULL_FRAME) // for cts testSingleImageThumbnail
    {  256,  144, SIZE_RATIO_16_9}, /* for CAMERA2_API_SUPPORT */
#endif
};
...
static int IMX240_2P2_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    ...
    { 1088, 1088, SIZE_RATIO_1_1},
    { 1280,  720, SIZE_RATIO_16_9},
#if defined(ENABLE_8MP_FULL_FRAME) //cts testSupportedVideoSizes
    { 1024,  768, SIZE_RATIO_4_3},
    { 1056,  704, SIZE_RATIO_3_2},
#endif
    {  960,  720, SIZE_RATIO_4_3},
