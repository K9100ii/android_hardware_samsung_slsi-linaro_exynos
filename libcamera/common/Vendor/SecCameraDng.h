 ...
 */
#ifndef EXYNOS_DNG_H_
#define EXYNOS_DNG_H_
...
#define DNG_HEADER_FILE_SIZE                    0x64A8

#define NUM_SIZE                                2
#define IFD_SIZE                                12
#define DNG_OFFSET_SIZE                         4
#define NUM_0TH_IFD                             0x2F
...
const uint8_t TIFF_DEF_EXIF_VERSION[4] = {0x30, 0x32, 0x32, 0x30};
