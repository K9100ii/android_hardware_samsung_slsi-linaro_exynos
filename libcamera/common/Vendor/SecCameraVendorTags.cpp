...
const char* SecCameraVendorTags::get_ext_section_name(const vendor_tag_ops_t *v,
        uint32_t tag) {
...
const char* SecCameraVendorTags::get_ext_tag_name(const vendor_tag_ops_t *v,
        uint32_t tag) {
    int tag_section = (tag >> 16) - VENDOR_SECTION;
...
int SecCameraVendorTags::get_ext_tag_type(const vendor_tag_ops_t *v,
        uint32_t tag) {
    int tag_section = (tag >> 16) - VENDOR_SECTION;
    int tag_index = tag & 0xFFFF;
...
int SecCameraVendorTags::get_ext_tag_count(const vendor_tag_ops_t *v) {
    int section;
    int count = 0;
    uint32_t start, end;
...
void SecCameraVendorTags::get_ext_all_tags(const vendor_tag_ops_t *v, uint32_t *tag_array) {
    int section;
