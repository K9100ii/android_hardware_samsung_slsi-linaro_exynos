...
ExynosCamera3SensorInfoBase::ExynosCamera3SensorInfoBase() : ExynosSensorInfoBase()
{
    ...
    */
    ...
    colorTransformMatrix1 = NULL;
    colorTransformMatrix2 = NULL;
    forwardMatrix1 = NULL;
    forwardMatrix2 = NULL;
    calibration1 = NULL;
    calibration2 = NULL;
...
ExynosCamera3SensorIMX260_2L1Base::ExynosCamera3SensorIMX260_2L1Base(int sensorId) : ExynosCamera3SensorInfoBase()
{
    ...
    rearPictureListMax          = sizeof(IMX260_2L1_YUV_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    rearPictureList             = IMX260_2L1_YUV_LIST;
