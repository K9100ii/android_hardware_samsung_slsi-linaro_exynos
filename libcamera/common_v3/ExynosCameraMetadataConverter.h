...
public:
    ...
    virtual status_t        updateDynamicMeta(ExynosCameraRequestSP_sprt_t requestInfo) = 0;
...
public:
    ...
    virtual status_t        updateDynamicMeta(ExynosCameraRequestSP_sprt_t requestInfo);
