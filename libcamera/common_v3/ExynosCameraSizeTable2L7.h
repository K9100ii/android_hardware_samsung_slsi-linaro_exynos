...
static int PREVIEW_SIZE_LUT_S5K2L7_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int VIDEO_SIZE_LUT_S5K2L7_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_S5K2L7_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int LIVE_BROADCAST_SIZE_LUT_IS5K2L7[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int YUV_SIZE_LUT_S5K2L7[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int DEPTH_MAP_SIZE_LUT_S5K2L7[][SIZE_OF_RESOLUTION] =
{
    { SIZE_RATIO_16_9,
        504      ,  282      ,   /* [vci    ] */
    },
...
static int S5K2L7_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K2L7_HIDDEN_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
#if !(defined(CAMERA_LCD_SIZE) && (CAMERA_LCD_SIZE >= LCD_SIZE_1920_1080))
    { 1920, 1080, SIZE_RATIO_16_9},
    { 1440, 1080, SIZE_RATIO_4_3},
...
static int S5K2L7_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
    ...
    {  960,  720, SIZE_RATIO_4_3},
    {  640,  480, SIZE_RATIO_4_3},
    {  320,  240, SIZE_RATIO_4_3}, /* CTS : testAvailableStreamConfigs */
};

static int S5K2L7_HIDDEN_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K2L7_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K2L7_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920, 1080, SIZE_RATIO_16_9},
    { 1440, 1440, SIZE_RATIO_1_1},
    { 1440, 1080, SIZE_RATIO_4_3},
...
static int S5K2L7_HIDDEN_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int S5K2L7_HIDDEN_FPS_RANGE_LIST[][2] =
{
    {  10000,  24000},
    {  30000,  60000},
    {  60000,  60000},
