...
static int VIDEO_SIZE_LUT_60FPS_HIGH_SPEED_2P8[][SIZE_OF_LUT] =
{
    ...
    /* FHD_60 16:9 (Single) */
    { SIZE_RATIO_16_9,
     (2656 + 8) ,(1494 + 6 ),   /* [sensor ] *//* Sensor binning ratio = 2 */
      2664      , 1500      ,   /* [bns    ] */
      2656      , 1494      ,   /* [bcrop  ] */
      2656      , 1494      ,   /* [bds    ] */
      1920      , 1080      ,   /* [target ] */
...
static int VIDEO_SIZE_LUT_60FPS_HIGH_SPEED_2P8_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_2P8[][SIZE_OF_LUT] =
{
    ...
    /* HD_120 16:9 (Single) */
    { SIZE_RATIO_16_9,
     (1312 + 16),( 738 + 10),   /* [sensor ] *//* Sensor binning ratio = 4 */
      1328      ,  748      ,   /* [bns    ] */
      1312      ,  738      ,   /* [bcrop  ] */
      1312      ,  738      ,   /* [bds    ] */
      1280      ,  720      ,   /* [target ] */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_2P8_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_HIGH_SPEED_2P8_BDS[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
    ...
    /* WVGA_300 5:3 (Single) */
    { SIZE_RATIO_5_3,
     ( 808 + 16),( 486 + 10),   /* [sensor ] *//* Sensor binning ratio = 6 */
       824      ,  496      ,   /* [bns    ] */
       810      ,  486      ,   /* [bcrop  ] */
       800      ,  480      ,   /* [bds    ] */
       800      ,  480      ,   /* [target ] */
