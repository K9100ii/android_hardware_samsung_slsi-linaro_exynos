...
#ifndef EXYNOS_CAMERA_LUT_IMX258_H
#define EXYNOS_CAMERA_LUT_IMX258_H
...
static int PREVIEW_SIZE_LUT_IMX258[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PREVIEW_SIZE_LUT_IMX258_BNS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 2.0
       BDS       = OFF */
...
static int PICTURE_SIZE_LUT_IMX258[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VIDEO_SIZE_LUT_IMX258[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int VIDEO_SIZE_LUT_IMX258_BNS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 2.0
       BDS       = 1080p */
...
static int VIDEO_SIZE_LUT_60FPS_HIGH_SPEED_IMX258[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_IMX258[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VTCALL_SIZE_LUT_IMX258[][SIZE_OF_LUT] =
{
    /* 16:9 (VT_Call) */
    { SIZE_RATIO_16_9,
     (2056 + 16),(1542 + 10),   /* [sensor ] */
...
static int IMX258_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX258_HIDDEN_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
#if defined(CAMERA_LCD_SIZE) && (CAMERA_LCD_SIZE >= LCD_SIZE_1920_1080)
...
static int IMX258_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX258_HIDDEN_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
    ...
    { 1728, 1152, SIZE_RATIO_3_2},
    { 1536, 1536, SIZE_RATIO_1_1},
    {  992,  744, SIZE_RATIO_4_3},
    {  992,  558, SIZE_RATIO_16_9},
};

static int IMX258_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX258_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920, 1080, SIZE_RATIO_16_9},
    { 1440, 1080, SIZE_RATIO_4_3},
    { 1280,  720, SIZE_RATIO_16_9},
...
static int IMX258_HIDDEN_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX258_YUV_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4128, 3096, SIZE_RATIO_4_3},
    { 4128, 2322, SIZE_RATIO_16_9},
    { 3264, 2448, SIZE_RATIO_4_3},
...
static int IMX258_HIGH_SPEED_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1280,  720, SIZE_RATIO_16_9},
};

static int IMX258_HIGH_SPEED_VIDEO_FPS_RANGE_LIST[][2] =
{
    {  30000, 120000},
    { 120000, 120000},
};

static int IMX258_FPS_RANGE_LIST[][2] =
{
    {   7000,   7000},
    {  15000,  15000},
    {  24000,  24000},
...
static int IMX258_HIDDEN_FPS_RANGE_LIST[][2] =
{
    {  10000,  24000},
    {  30000,  60000},
    {  60000,  60000},
...
static camera_metadata_rational UNIT_MATRIX_IMX258_3X3[] =
{
    {128, 128}, {0, 128}, {0, 128},
    {0, 128}, {128, 128}, {0, 128},
    {0, 128}, {0, 128}, {128, 128}
