...
ExynosCamera3SensorS5K5E6Base::ExynosCamera3SensorS5K5E6Base() : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    testPatternModes = AVAILABLE_TEST_PATTERN_MODES;
    testPatternModesLength = ARRAY_LENGTH(AVAILABLE_TEST_PATTERN_MODES);
    colorTransformMatrix1 = UNIT_MATRIX_5E6_3X3;
    colorTransformMatrix2 = UNIT_MATRIX_5E6_3X3;
    forwardMatrix1 = UNIT_MATRIX_5E6_3X3;
    forwardMatrix2 = UNIT_MATRIX_5E6_3X3;
    calibration1 = UNIT_MATRIX_5E6_3X3;
    calibration2 = UNIT_MATRIX_5E6_3X3;
...
ExynosCamera3SensorIMX320_3H1Base::ExynosCamera3SensorIMX320_3H1Base(int sensorId) : ExynosCamera3SensorInfoBase()
{
  ...
  /*
    ...
    */
    ...
    focalLengthIn35mmLength = 22;
    hyperFocalDistance = 0.0f;
    /* HACK: disable to pass CTS in GED */
    minimumFocusDistance = 0.0f / 0.1f;
    if (minimumFocusDistance > 0.0f) {
        afModes = AVAILABLE_AF_MODES;
        afModesLength = ARRAY_LENGTH(AVAILABLE_AF_MODES);
        focusDistanceCalibration = ANDROID_LENS_INFO_FOCUS_DISTANCE_CALIBRATION_CALIBRATED;
    ...
    testPatternModes = AVAILABLE_TEST_PATTERN_MODES;
    testPatternModesLength = ARRAY_LENGTH(AVAILABLE_TEST_PATTERN_MODES);
    colorTransformMatrix1 = UNIT_MATRIX_IMX320_3H1_3X3;
    colorTransformMatrix2 = UNIT_MATRIX_IMX320_3H1_3X3;
    forwardMatrix1 = UNIT_MATRIX_IMX320_3H1_3X3;
    forwardMatrix2 = UNIT_MATRIX_IMX320_3H1_3X3;
    calibration1 = UNIT_MATRIX_IMX320_3H1_3X3;
    calibration2 = UNIT_MATRIX_IMX320_3H1_3X3;
...
ExynosCamera3SensorS5K4H5YCBase::ExynosCamera3SensorS5K4H5YCBase() : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_4H5_YC_3X3;
    calibration2 = UNIT_MATRIX_4H5_YC_3X3;
...
ExynosCamera3SensorSR544Base::ExynosCamera3SensorSR544Base() : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_SR544_3X3;
    calibration2 = UNIT_MATRIX_SR544_3X3;
...
/*
    ...
    */
    ...
    testPatternModes = AVAILABLE_TEST_PATTERN_MODES;
    testPatternModesLength = ARRAY_LENGTH(AVAILABLE_TEST_PATTERN_MODES);
    colorTransformMatrix1 = UNIT_MATRIX_SR259_3X3;
    colorTransformMatrix2 = UNIT_MATRIX_SR259_3X3;
    forwardMatrix1 = UNIT_MATRIX_SR259_3X3;
    forwardMatrix2 = UNIT_MATRIX_SR259_3X3;
    calibration1 = UNIT_MATRIX_SR259_3X3;
    calibration2 = UNIT_MATRIX_SR259_3X3;
...
ExynosCamera3SensorIMX258Base::ExynosCamera3SensorIMX258Base() : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_IMX258_3X3;
    calibration2 = UNIT_MATRIX_IMX258_3X3;
...
ExynosCamera3SensorIMX333_2L2Base::ExynosCamera3SensorIMX333_2L2Base(int sensorId) : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_IMX333_2L2_3X3;
    calibration2 = UNIT_MATRIX_IMX333_2L2_3X3;
...
ExynosCamera3SensorS5K2L7Base::ExynosCamera3SensorS5K2L7Base(int sensorId) : ExynosCamera3SensorInfoBase()
{
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_S5K2L7_3X3;
    calibration2 = UNIT_MATRIX_S5K2L7_3X3;
...
void ExynosCamera3SensorS5K3M3Base::m_init(int cameraId)
{
  ...
  /*
    ...
    */
    ...
    calibration1 = UNIT_MATRIX_3M3_3X3; /* Copied from 2L1 setting */
    calibration2 = UNIT_MATRIX_3M3_3X3; /* Copied from 2L1 setting */
