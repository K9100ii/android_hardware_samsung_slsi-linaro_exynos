...
void ExynosSensorS5K3L8Base::m_init(int cameraId)
{
    maxPreviewW = 1920;
    maxPreviewH = 1080;
    maxPictureW = 4160;
...
void ExynosSensorS5K3M3Base::m_init(int cameraId)
{
    maxPreviewW = 1920;
    maxPreviewH = 1080;
    maxPictureW = 4160;
