...
int ExynosCameraActivityFlash::t_funcSCCBefore(__unused void *args)
{
    return 1;
}

int ExynosCameraActivityFlash::t_funcSCCAfter(__unused void *args)
{
    return 1;
}
...
{
    CLOGD("exposureTime(%ju)", exposureTime);
