...
enum SRC_BUFFER_COUNT
{
    ...
    SRC_BUFFER_COUNT_MAX = MAX_OUTPUT_NODE, /* this must same with MAX_OUTPUT_NODE */
};
...
public:
    ...
    uint32_t        getAdjustSync(uint32_t srcNodeIndex = 0);
#endif
    ...
    void        setFrameServiceYuvCbStall (bool flag) {
        m_serviceYuvCbStall  = flag;
    }

    bool        getFrameServiceYuvCbStall(void) {
        return m_serviceYuvCbStall ;
    }
...
private:
    ...
    unsigned long long          m_privateCheckLeakFrameCount;
#endif
