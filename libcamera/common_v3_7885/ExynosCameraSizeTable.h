...
// This is for just to fix build error. you should add new LUT if you want to use 2L7 for FHD LCD project.
#include "ExynosCameraSizeTable2L7_WQHD.h"
#endif
...
#elif defined(USE_REAR_NO_SENSOR_MARGIN)
#include "ExynosCameraSizeTable3P3_NO_MARGIN.h"
#else
...
#endif
#include "ExynosCameraSizeTable5E6.h"
...
#include "ExynosCameraSizeTable2P6.h"
