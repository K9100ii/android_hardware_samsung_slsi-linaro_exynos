...
static int LIVE_BROADCAST_SIZE_LUT_IIMX333_2L2[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int YUV_SIZE_LUT_IMX333_2L2[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int DEPTH_MAP_SIZE_LUT_IMX333_2L2[][SIZE_OF_RESOLUTION] =
{
    { SIZE_RATIO_16_9,
        504      ,  282      ,   /* [vci    ] */
    },
...
static int IMX333_2L2_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX333_2L2_HIDDEN_PREVIEW_LIST[][SIZE_OF_RESOLUTION] =
{
#if !(defined(CAMERA_LCD_SIZE) && (CAMERA_LCD_SIZE >= LCD_SIZE_1920_1080))
    { 1920, 1080, SIZE_RATIO_16_9},
    { 1440, 1080, SIZE_RATIO_4_3},
...
static int IMX333_2L2_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int IMX333_2L2_DNG_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4032, 3024, SIZE_RATIO_4_3},
    { 4032, 2268, SIZE_RATIO_16_9},
...
static int IMX333_2L2_HIDDEN_PICTURE_LIST[][SIZE_OF_RESOLUTION] =
{
...
/* 
1. Skia Constraint 
    - image size : DNG original Size /N
    - target size : thumbnail size(dng)
    - 1.000 <= image size/target size <= 1.03
2. CTS : testJpegExif
    - ascending order about image size (width * height)
*/
static int IMX333_2L2_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
    {  504,  376, SIZE_RATIO_4_3},  //(1/8)    1.0     1.005
    {  376,  376, SIZE_RATIO_1_1},  //(1/8)    1.005   1.005
    {  496,  280, SIZE_RATIO_16_9}, //(1/8)    1.016   1.012 
...
/*
1. Special case
    - No expose to framework & app
    - This setting will be set by SamsungCamera (hardcoded)
*/
static int IMX333_2L2_HIDDEN_THUMBNAIL_LIST[][SIZE_OF_RESOLUTION] =
{
    {  496,  240, SIZE_RATIO_18P5_9},  //(1/8)    1.016     1.020
    {    0,    0, SIZE_RATIO_1_1}
};

static int IMX333_2L2_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920, 1080, SIZE_RATIO_16_9},
    { 1440, 1440, SIZE_RATIO_1_1},
    { 1440, 1080, SIZE_RATIO_4_3},
...
static int IMX333_2L2_HIDDEN_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
...
static camera_metadata_rational UNIT_MATRIX_IMX333_2L2_3X3[] =
{
    {128, 128}, {0, 128}, {0, 128},
    {0, 128}, {128, 128}, {0, 128},
    {0, 128}, {0, 128}, {128, 128}
