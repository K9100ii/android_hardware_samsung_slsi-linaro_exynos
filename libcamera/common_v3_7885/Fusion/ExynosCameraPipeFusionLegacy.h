...
#include "ExynosCameraFusionWrapperCP.h"
#endif
...
private:
    ...
    status_t                m_manageFusion(ExynosCameraFrameSP_sptr_t newFrame);
...
private:
    class ExynosCameraFusionMutex: public ExynosCameraSingleton<ExynosCameraFusionMutex>
    {
    protected:
        friend class ExynosCameraSingleton<ExynosCameraFusionMutex>;

        //! Constructor
        ExynosCameraFusionMutex(){};

        //! Destructor
        virtual ~ExynosCameraFusionMutex(){};

    public:
        Mutex *getFusionMutex(void)
        {
            return &m_fusionMutex;
        }
