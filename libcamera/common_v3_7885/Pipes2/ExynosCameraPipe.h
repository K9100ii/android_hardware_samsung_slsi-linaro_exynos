...
public:
    ...
    virtual status_t        flushInputFrameQ(void) { return NO_ERROR; };
    virtual status_t        flushRequestFrameQ(void) { return NO_ERROR; };
    ...
    virtual status_t        instantOnQbuf(ExynosCameraFrameSP_dptr_t frame, BUFFER_POS::POS pos);
    virtual status_t        instantOnDQbuf(ExynosCameraFrameSP_dptr_t frame, BUFFER_POS::POS pos);
