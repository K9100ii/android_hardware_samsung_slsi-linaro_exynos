...
protected:
    ...
    ExynosCameraPP(int cameraId, int nodeNum)
    {
        m_init();
...
public:
    ...
    virtual char    *getName(void) final;
    ...
    virtual status_t draw(ExynosCameraImage srcImage, ExynosCameraImage dstImage) final;

    virtual status_t draw(int numOfSrcImage, ExynosCameraImage *srcImage,
                          int numOfDstImage, ExynosCameraImage *dstImage) final;
...
protected:
    ...
    virtual status_t m_draw(int numOfSrcImage, ExynosCameraImage *srcImage,
