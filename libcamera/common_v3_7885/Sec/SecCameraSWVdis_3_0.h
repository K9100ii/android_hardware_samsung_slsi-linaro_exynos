...
#define NUM_VDIS_UHD_BUFFERS 21
#define NUM_VDIS_PREVIEW_INFO_BUFFERS 16
#define NUM_VDIS_PREVIEW_DELAY 2

#define NUM_VDIS_OUT_BUFFERS_MAX FPS60_NUM_RECORDING_BUFFERS
...
extern int m_swVDIS_GetVDISOutInfo(nsecs_t *timeStamp);
extern int m_swVDIS_GetPreviewVDISInfo();
