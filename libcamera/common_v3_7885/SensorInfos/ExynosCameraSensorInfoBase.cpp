...
#if defined (MAIN_1_CAMERA_SENSOR_NAME) || (FRONT_1_CAMERA_SENSOR_NAME)
    int sensor1Name = -1;
#endif
...
ExynosSensorInfoBase::ExynosSensorInfoBase()
{
    ...
    rearDngPictureListMax = 0;
    frontPictureListMax = 0;
    frontDngPictureListMax = 0;
    ...
    rearDngPictureList = NULL;
    frontPictureList = NULL;
    frontDngPictureList = NULL;
...
void ExynosSensorS5K3L8Base::m_init(__unused int cameraId)
{
    maxPreviewW = 1920;
    maxPreviewH = 1080;
    maxPictureW = 4160;
...
ExynosSensorS5K2P8Base::ExynosSensorS5K2P8Base(int cameraId) : ExynosSensorInfoBase()
{
    maxZoomLevel = MAX_ZOOM_LEVEL;
    maxZoomRatio = MAX_ZOOM_RATIO;
...
//        videoSizeLutMax       = sizeof(VIDEO_SIZE_LUT_2P8_FHD)   / (sizeof(int) * SIZE_OF_LUT);
...
//        videoSizeLut                = VIDEO_SIZE_LUT_2P8_FHD;
        //videoSizeBnsLut             = VIDEO_SIZE_LUT_2P8_BDS_BNS15_FHD;
...
//        videoSizeLutHighSpeed120    = VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_4H5;
    ...
    if (cameraId == CAMERA_ID_FRONT) {
        /* Set the max of preview/picture/video lists */
        frontPreviewListMax      = sizeof(S5K2P8_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        frontPictureListMax      = sizeof(S5K2P8_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        hiddenFrontPreviewListMax    = sizeof(S5K2P8_HIDDEN_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        hiddenFrontPictureListMax    = sizeof(S5K2P8_HIDDEN_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        thumbnailListMax    = sizeof(S5K2P8_THUMBNAIL_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        frontVideoListMax        = sizeof(S5K2P8_VIDEO_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        hiddenFrontVideoListMax    = sizeof(S5K2P8_HIDDEN_VIDEO_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
        frontFPSListMax        = sizeof(S5K2P8_FPS_RANGE_LIST) / (sizeof(int) * 2);
        hiddenFrontFPSListMax    = sizeof(S5K2P8_HIDDEN_FPS_RANGE_LIST) / (sizeof(int) * 2);

        /* Set supported preview/picture/video lists */
        frontPreviewList     = S5K2P8_PREVIEW_LIST;
        frontPictureList     = S5K2P8_PICTURE_LIST;
        hiddenFrontPreviewList   = S5K2P8_HIDDEN_PREVIEW_LIST;
        hiddenFrontPictureList   = S5K2P8_HIDDEN_PICTURE_LIST;
        thumbnailList   = S5K2P8_THUMBNAIL_LIST;
        frontVideoList       = S5K2P8_VIDEO_LIST;
        hiddenFrontVideoList   = S5K2P8_HIDDEN_VIDEO_LIST;
        frontFPSList       = S5K2P8_FPS_RANGE_LIST;
        hiddenFrontFPSList   = S5K2P8_HIDDEN_FPS_RANGE_LIST;
    } else {
        /* Set the max of preview/picture/video lists */
...
ExynosSensorSR259Base::ExynosSensorSR259Base() : ExynosSensorInfoBase()
{
    ...
    horizontalViewAngle[SIZE_RATIO_16_9] = 58.8f;
    horizontalViewAngle[SIZE_RATIO_4_3] = 58.8f;
    horizontalViewAngle[SIZE_RATIO_1_1] = 46.0f;
    horizontalViewAngle[SIZE_RATIO_3_2] = 55.2f;
    horizontalViewAngle[SIZE_RATIO_5_4] = 48.8f;
    horizontalViewAngle[SIZE_RATIO_5_3] = 58.4f;
    horizontalViewAngle[SIZE_RATIO_11_9] = 48.8f;
...
void ExynosSensorS5K3M3Base::m_init(__unused int cameraId)
{
    maxPreviewW = 3840;
    maxPreviewH = 2160;
    maxPictureW = 4032;
    ...
    horizontalViewAngle[SIZE_RATIO_16_9] = 37.0f;
    horizontalViewAngle[SIZE_RATIO_4_3] = 37.0f;
    horizontalViewAngle[SIZE_RATIO_1_1] = 28.2f;
    horizontalViewAngle[SIZE_RATIO_3_2] = 37.0f;
    horizontalViewAngle[SIZE_RATIO_5_4] = 34.9f;
    horizontalViewAngle[SIZE_RATIO_5_3] = 37.0f;
    horizontalViewAngle[SIZE_RATIO_11_9] = 34.2f;
    verticalViewAngle = 28.2f;
...
ExynosSensorIMX320_3H1Base::ExynosSensorIMX320_3H1Base() : ExynosSensorInfoBase()
{
    maxPreviewW = 2560;
    maxPreviewH = 1440;
    maxPictureW = 3264;
...
#endif
    dualPreviewSizeLut          = DUAL_PREVIEW_SIZE_LUT_IMX320_3H1;
    dualVideoSizeLut            = DUAL_VIDEO_SIZE_LUT_IMX320_3H1;
    videoSizeBnsLut             = NULL;
    ...
    /* Set the max of preview/picture/video lists */
    frontPreviewListMax      = sizeof(IMX320_3H1_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    frontPictureListMax      = sizeof(IMX320_3H1_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    /* Set supported preview/picture/video lists */
    frontPreviewList     = IMX320_3H1_PREVIEW_LIST;
    frontPictureList     = IMX320_3H1_PICTURE_LIST;
...
ExynosSensorS5K5E6Base::ExynosSensorS5K5E6Base() : ExynosSensorInfoBase()
{
    maxPreviewW = 1920;
    maxPreviewH = 1920;
    maxPictureW = 1920;
    ...
    previewSizeLutMax           = sizeof(PREVIEW_SIZE_LUT_5E6) / (sizeof(int) * SIZE_OF_LUT);
    pictureSizeLutMax           = sizeof(PICTURE_SIZE_LUT_5E6) / (sizeof(int) * SIZE_OF_LUT);
    videoSizeLutMax             = sizeof(VIDEO_SIZE_LUT_5E6) / (sizeof(int) * SIZE_OF_LUT);
    videoSizeLutHighSpeed60Max  = 0;
    videoSizeLutHighSpeed120Max = 0;

    previewSizeLut              = PREVIEW_SIZE_LUT_5E6;
    pictureSizeLut              = PICTURE_SIZE_LUT_5E6;
    videoSizeLut                = VIDEO_SIZE_LUT_5E6;
    dualVideoSizeLut            = VIDEO_SIZE_LUT_5E6;
    videoSizeBnsLut             = NULL;
    videoSizeLutHighSpeed60     = NULL;
    videoSizeLutHighSpeed120    = NULL;
    sizeTableSupport            = true;
    ...
    /* Set the max of preview/picture/video lists */
    frontPreviewListMax      = sizeof(S5K5E6_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    frontPictureListMax      = sizeof(S5K5E6_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    /* Set supported preview/picture/video lists */
    frontPreviewList     = S5K5E6_PREVIEW_LIST;
    frontPictureList     = S5K5E6_PICTURE_LIST;
...
ExynosSensorIMX333_2L2Base::ExynosSensorIMX333_2L2Base() : ExynosSensorInfoBase()
{
    maxPreviewW = 3840;
    maxPreviewH = 2160;
    maxPictureW = 4032;
    ...
    if (bnsSupport == true) {
...
#if defined(USE_BNS_PREVIEW)
        previewSizeLutMax     = sizeof(PREVIEW_SIZE_LUT_IMX333_2L2_BNS) / (sizeof(int) * SIZE_OF_LUT);
#else
        ...
        liveBroadcastSizeLutMax     = sizeof(LIVE_BROADCAST_SIZE_LUT_IIMX333_2L2) / (sizeof(int) * SIZE_OF_LUT);
#if defined(USE_BNS_PREVIEW)
        previewSizeLut              = PREVIEW_SIZE_LUT_IMX333_2L2_BNS;
#else
        previewSizeLut              = PREVIEW_SIZE_LUT_IMX333_2L2;
#endif
#if defined(USE_BNS_DUAL_PREVIEW)
        dualPreviewSizeLut          = PREVIEW_SIZE_LUT_IMX333_2L2_BNS;
#else
        ...
        liveBroadcastSizeLut        = LIVE_BROADCAST_SIZE_LUT_IIMX333_2L2;
        sizeTableSupport            = true;
    } else {
        previewSizeLutMax     = 0;
        pictureSizeLutMax     = 0;
    ...
    /* Set the max of preview/picture/video lists */
    rearPreviewListMax      = sizeof(IMX333_2L2_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    rearPictureListMax      = sizeof(IMX333_2L2_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    rearDngPictureListMax   = sizeof(IMX333_2L2_DNG_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    /* Set supported preview/picture/video lists */
    rearPreviewList     = IMX333_2L2_PREVIEW_LIST;
    rearPictureList     = IMX333_2L2_PICTURE_LIST;
    rearDngPictureList  = IMX333_2L2_DNG_PICTURE_LIST;
...
ExynosSensorS5K2L7Base::ExynosSensorS5K2L7Base() : ExynosSensorInfoBase()
{
    maxPreviewW = 3840;
    maxPreviewH = 2160;
    maxPictureW = 4032;
    ...
    if (bnsSupport == true) {
        ...
        liveBroadcastSizeLutMax     = sizeof(LIVE_BROADCAST_SIZE_LUT_IS5K2L7) / (sizeof(int) * SIZE_OF_LUT);
#if defined(USE_BNS_PREVIEW)
        ...
        liveBroadcastSizeLut        = LIVE_BROADCAST_SIZE_LUT_IS5K2L7;
        sizeTableSupport            = true;
    } else {
        previewSizeLutMax     = 0;
        pictureSizeLutMax     = 0;
    ...
    /* Set the max of preview/picture/video lists */
    rearPreviewListMax      = sizeof(S5K2L7_PREVIEW_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    rearPictureListMax      = sizeof(S5K2L7_PICTURE_LIST) / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    /* Set supported preview/picture/video lists */
    rearPreviewList     = S5K2L7_PREVIEW_LIST;
    rearPictureList     = S5K2L7_PICTURE_LIST;
...
ExynosSensorS5K2P6Base::ExynosSensorS5K2P6Base() : ExynosSensorInfoBase()
{
    maxPreviewW = 3840;
    maxPreviewH = 2160;
    maxPictureW = 4608;
...
void ExynosSensorS5K3P8SPBase::m_init(int cameraId)
{
    ...
    if (bnsSupport == true) {
        ...
        pictureSizeLutMax           = sizeof(PICTURE_SIZE_LUT_S5K3P8SP_BNS) / (sizeof(int) * SIZE_OF_LUT);
        ...
        hrPreviewSizeLutMax         = sizeof(PREVIEW_SIZE_LUT_S5K3P8SP) / (sizeof(int) * SIZE_OF_LUT);
        hrPictureSizeLutMax         = sizeof(PICTURE_SIZE_LUT_S5K3P8SP) / (sizeof(int) * SIZE_OF_LUT);
        hrPreviewSizeLut            = PREVIEW_SIZE_LUT_S5K3P8SP;
        hrPictureSizeLut            = pictureSizeLut;
        bpPictureSizeLut            = PICTURE_SIZE_LUT_S5K3P8SP_BNS;
#endif
