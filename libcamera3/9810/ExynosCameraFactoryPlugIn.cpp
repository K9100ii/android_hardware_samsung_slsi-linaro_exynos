...
status_t ExynosCameraFactoryPlugIn::create(int cameraId, int pipeId, ExynosCameraPlugInSP_dptr_t plugIn, ExynosCameraPlugInConverterSP_dptr_t converter)
{
    int refCount;
    ...
    Mutex::Autolock lock(m_lock);
    {
        ...
        if (plugIn == NULL) {
            ...
            *(reinterpret_cast<void **>(&createSymbol)) = dlsym(libHandle, PLUGIN_SYMBOL_NAME);
            ...
            plugIn = (ExynosCameraPlugIn *)createSymbol(cameraId, pipeId);
            if (plugIn != NULL) {
