...
public:
    ...
    ExynosCameraFrameFactory(int cameraId, ExynosCameraConfigurations *configurations, ExynosCameraParameters *param)
        : ExynosCameraFrameFactoryBase(cameraId, configurations, param)
    {
        m_init();
    }
