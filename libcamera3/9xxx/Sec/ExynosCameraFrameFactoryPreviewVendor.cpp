...
#ifdef USES_SW_VDIS
    /* VDIS */
    ExynosCameraPipePlugIn *vdisPipe = new ExynosCameraPipePlugIn(m_cameraId, m_configurations, m_parameters, m_flagReprocessing, m_nodeNums[INDEX(PIPE_VDIS)], PLUGIN_SCENARIO_SWVDIS_PREVIEW);
