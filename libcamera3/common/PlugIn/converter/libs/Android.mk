...
LOCAL_C_INCLUDES += \
    $(TOP)/hardware/samsung_slsi/exynos/libcamera3/common/PlugIn/converter/libs/libFakeFusion
LOCAL_SRC_FILES += \
...
LOCAL_C_INCLUDES += \
    $(TOP)/hardware/samsung_slsi/exynos/libcamera3/common/PlugIn/converter/libs/libLLS
LOCAL_SRC_FILES += \
