...
ExynosCameraSensorIMX333_2L2Base::ExynosCameraSensorIMX333_2L2Base(int sensorId) : ExynosCameraSensorInfoBase()
{
    maxSensorW = 4032;
    maxSensorH = 3024;
    maxPreviewW = 4032;
    ...
    dualPreviewSizeLut          = PREVIEW_FULL_SIZE_LUT_IMX333_2L2;
...
ExynosCameraSensor2L3Base::ExynosCameraSensor2L3Base(int sensorId) : ExynosCameraSensorInfoBase()
{
    maxSensorW = 4032;
    maxSensorH = 3024;
    maxPreviewW = 4032;
    ...
    dualPreviewSizeLut          = PREVIEW_FULL_SIZE_LUT_2L3;
    ...
    thumbnailListMax            = sizeof(SAK2L3_THUMBNAIL_LIST)                     / (sizeof(int) * SIZE_OF_RESOLUTION);
    ...
    thumbnailList               = SAK2L3_THUMBNAIL_LIST;
...
ExynosCameraSensorIMX320_3H1Base::ExynosCameraSensorIMX320_3H1Base(__unused int sensorId) : ExynosCameraSensorInfoBase()
{
    ...
    supportedCapabilities = (CAPABILITIES_BACKWARD_COMPATIBLE | CAPABILITIES_MANUAL_SENSOR | CAPABILITIES_MANUAL_POST_PROCESSING |
                            CAPABILITIES_BURST_CAPTURE | CAPABILITIES_PRIVATE_REPROCESSING);
    requestKeys = AVAILABLE_REQUEST_KEYS_BASIC;
    resultKeys = AVAILABLE_RESULT_KEYS_BASIC;
    characteristicsKeys = AVAILABLE_CHARACTERISTICS_KEYS_BASIC;
    requestKeysLength = ARRAY_LENGTH(AVAILABLE_REQUEST_KEYS_BASIC);
