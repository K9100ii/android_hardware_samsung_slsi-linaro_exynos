...
public:
    ...
    ExynosCameraFrameSP_sptr_t  createFrame(ExynosCameraConfigurations *configurations,
                                            uint32_t framecnt,
...
private:
    ...
    ExynosCameraFrameSP_sptr_t m_createFrame(ExynosCameraConfigurations *configurations, uint32_t framecnt, uint32_t frametype = 0);
