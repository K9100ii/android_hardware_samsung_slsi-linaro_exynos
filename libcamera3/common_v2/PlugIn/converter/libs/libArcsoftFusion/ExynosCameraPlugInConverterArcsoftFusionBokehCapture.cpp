...
//#define LOG_NDEBUG 0
#define LOG_TAG "ExynosCameraPlugInConverterArcsoftFusionBokehCapture"
...
/*  protected functions                      */
/*********************************************/
status_t ExynosCameraPlugInConverterArcsoftFusionBokehCapture::m_init(void)
{
    strncpy(m_name, "ConverterArcsoftFusionBokehCapture", (PLUGIN_NAME_STR_SIZE - 1));

    return NO_ERROR;
}

status_t ExynosCameraPlugInConverterArcsoftFusionBokehCapture::m_make(Map_t *map)
{
    ALOGD("ExynosCameraPlugInConverterArcsoftFusionBokehCapture::m_make in");
...
status_t ExynosCameraPlugInConverterArcsoftFusionBokehCapture::m_convertParameters2Map(ExynosCameraConfigurations *configurations,
