...
class ExynosCameraPlugInConverterFakeFusion : public virtual ExynosCameraPlugInConverter {
public:
    ExynosCameraPlugInConverterFakeFusion() : ExynosCameraPlugInConverter()
    {
        m_init();
    }

    ExynosCameraPlugInConverterFakeFusion(int cameraId, int pipeId) : ExynosCameraPlugInConverter(cameraId, pipeId)
    { 
        m_init();
    }

    virtual ~ExynosCameraPlugInConverterFakeFusion() { ALOGD("%s", __FUNCTION__); };
