...
ARC_DCVR_API MRESULT ARC_DCVR_GetDefaultParam(	// return MOK if success, otherwise fail
...
ARC_DCVR_API MRESULT ARC_DCVR_SetOCLKernel(			// return MOK if success, otherwise fail
  	MHandle				hHandle,				// [in]  The algorithm engine
