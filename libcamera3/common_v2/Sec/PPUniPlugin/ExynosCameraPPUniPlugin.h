...
enum PP_SCENARIO_TYPE {
    ...
    PP_SCENARIO_IDDQD,
    PP_SCENARIO_SW_VDIS,
    PP_SCENARIO_HYPERLAPSE,
    PP_SCENARIO_VIDEO_BEAUTY,
    PP_SCENARIO_VIDEO_BEAUTY_SNAPSHOT,
    PP_SCENARIO_MF_HDR,
    PP_SCENARIO_LL_HDR,
    PP_SCENARIO_HIFI_VIDEO,
    PP_SCENARIO_MAX,
};
...
enum PP_EXT_CONTROL_TYPE {
    PP_EXT_CONTROL_POWER_CONTROL,
    PP_EXT_CONTROL_SET_UNI_PLUGIN_HANDLE,
    PP_EXT_CONTROL_VDIS,
};
...
protected:
    ...
    UNI_PLUGIN_SENSOR_TYPE          m_checkUniSensorId(int cameraId);
    UNI_PLUGIN_SENSOR_TYPE          m_getUniSensorId(int cameraId);
    UNI_PLUGIN_SENSOR_TYPE          m_getUniAuxSensorId(int cameraId);
    UNI_PLUGIN_HDR_MODE             m_getUniHDRMode();
    UNI_PLUGIN_FLASH_MODE           m_getUniFlashMode();
    UNI_PLUGIN_DEVICE_ORIENTATION   m_getUniOrientationMode(bool captureFlag = false);
...
protected:
    ...
    UNI_PLUGIN_SENSOR_TYPE               m_sensorId;
    UNI_PLUGIN_SENSOR_TYPE               m_auxSensorId;
};
