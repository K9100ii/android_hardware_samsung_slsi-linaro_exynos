...
static vendor_tag_info_t seccamera_android_control[SAMSUNG_ANDROID_CONTROL_END -
    ...
    { "availableBurstShotFps",              TYPE_INT32  },
    ...
    { "effectAeAvailableTargetFpsRanges",   TYPE_INT32  },
    { "factoryDramTestState",               TYPE_BYTE   },
    { "superSlowMotionAutoDetectRegions",   TYPE_INT32  },
    { "superSlowMotionMode",                TYPE_INT32  },
    { "superSlowMotionTrigger",             TYPE_INT32  },
    { "superSlowMotionState",               TYPE_INT32  },
    { "bokehBlurStrength",                  TYPE_INT32  },
    { "zoomInOutPhoto",                     TYPE_INT32  },
    { "bokehState",                         TYPE_INT32  },
    { "dualCameraDisable",                  TYPE_BYTE   },
    { "beautyFaceRetouchLevel",             TYPE_INT32  },
    { "repeatingRequestHint",               TYPE_INT32  },
    { "latestPreviewTimestamp",             TYPE_INT64  },
    { "beautyFaceSkinColor",                TYPE_INT32  },
    { "sceneDetectionInfo",                 TYPE_INT64  },
    { "strBvOffset",                        TYPE_INT32  },
};
...
static vendor_tag_info_t seccamera_android_scaler[SAMSUNG_ANDROID_SCALER_END -
    ...
    { "availablePreviewStreamConfigurations",      TYPE_INT32  },
    { "availablePictureStreamConfigurations",      TYPE_INT32  },
    { "availableThumbnailStreamConfigurations",    TYPE_INT32  },
    { "availableHighSpeedVideoConfigurations",     TYPE_INT32  },
    { "availableIrisStreamConfigurations",         TYPE_INT32  },
