...
typedef enum camera_metadata_enum_samsung_android_control_live_hdr_state{
    SAMSUNG_ANDROID_CONTROL_LIVE_HDR_STATE_OFF = 0,
    SAMSUNG_ANDROID_CONTROL_LIVE_HDR_STATE_ON,
...
typedef enum camera_metadata_enum_samsung_android_control_available_feature {
    ...
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_SUPER_SLOW_MOTION             = 2,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_DUAL_ZOOM                     = 3,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_DUAL_BOKEH                    = 4,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_ZOOM_IN_OUT_PHOTO             = 5,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_VIDEO_BEAUTY_FACE             = 6,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_BEAUTY_FACE                   = 7,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_STR                           = 8,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_HDR10_RECORDING               = 9,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_SUPER_SLOW_MOTION_FRC         = 10,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_FACTORY_DRAM_TEST             = 100,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_FACTORY_LN_TEST               = 101,
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_FEATURE_FACTORY_SSM_TEST              = 102,
...
typedef enum camera_metadata_enum_samsung_android_control_shooting_mode {
    ...
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_AQUA_SCENE = 19,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_SUPER_SLOW_MOTION = 20,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_LIVE_FOCUS = 21,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_FACE_LOCK = 22,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_INTELLIGENT_SCAN = 23,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_STICKER = 24,
    SAMSUNG_ANDROID_CONTROL_SHOOTING_MODE_SELFIE_FOCUS = 25,
...
typedef enum camera_metadata_enum_samsung_android_control_capture_hint {
    ...
    SAMSUNG_ANDROID_CONTROL_CAPTURE_HINT_AGIF,
    SAMSUNG_ANDROID_CONTROL_CAPTURE_HINT_SR,
    SAMSUNG_ANDROID_CONTROL_CAPTURE_HINT_FACTORY_MAIN = 100,
    SAMSUNG_ANDROID_CONTROL_CAPTURE_HINT_FACTORY_SECONDARY = 101,
...
typedef enum camera_metadata_enum_samsung_android_control_super_slow_motion_mode {
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_MODE_MANUAL       = 0,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_MODE_AUTO_DETECT  = 1,
} camera_metadata_enum_samsung_android_control_super_slow_motion_mode_t;

typedef enum camera_metadata_enum_samsung_android_control_super_slow_motion_state {
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_STATE_UNDEFINED    = 0,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_STATE_READY        = 1,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_STATE_OPERATING    = 2,
} camera_metadata_enum_samsung_android_control_super_slow_motion_state_t;

typedef enum camera_metadata_enum_samsung_android_control_super_slow_motion_trigger {
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_TRIGGER_IDLE       = 0,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_TRIGGER_START      = 1,
} camera_metadata_enum_samsung_android_control_super_slow_motion_trigger_t;

typedef enum camera_metadata_enum_samsung_android_control_zoom_in_out_photo {
    SAMSUNG_ANDROID_CONTROL_ZOOM_IN_OUT_PHOTO_OFF = 0,
    SAMSUNG_ANDROID_CONTROL_ZOOM_IN_OUT_PHOTO_ON = 1,
} camera_metadata_enum_samsung_android_control_zoom_in_out_photo_t;

typedef enum camera_metadata_enum_samsung_android_control_bokehstate {
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_SUCCESS = 0,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_ERROR_INVALID_DEPTH = 1,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_ERROR_DISTANCE_TOO_FAR = 11,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_ERROR_DISTANCE_TOO_CLOSE = 12,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_ERROR_LENS_PARTIALLY_COVERED = 21,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_ERROR_LOW_LIGHT_CONDITION = 31,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_CAPTURE_PROCESSING_SUCCESS = 100,
    SAMSUNG_ANDROID_CONTROL_BOKEH_STATE_CAPTURE_PROCESSING_FAIL = 101,
} camera_metadata_enum_samsung_android_control_bokehstate_t;

typedef enum camera_metadata_enum_samsung_android_control_repeating_request_hint {
    SAMSUNG_ANDROID_CONTROL_REPEATING_REQUEST_HINT_NONE = 0,
    SAMSUNG_ANDROID_CONTROL_CONTROL_REPEATING_REQUEST_HINT_USING_GPU = 1 << 0,
} camera_metadata_enum_samsung_android_control_repeating_request_hint_t;

typedef enum camera_metadata_enum_samsung_android_control_super_slow_motion_shot_mode {
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_SHOT_MODE_NONE         = 0,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_SHOT_MODE_MULTI        = 1,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_SHOT_MODE_SINGLE       = 2,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_SHOT_MODE_MULTI_FRC    = 3,
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_SHOT_MODE_SINGLE_FRC   = 4,
} camera_metadata_enum_samsung_android_control_ssm_mode_t;
...
typedef struct camera_metadata_struct_samsung_android_scene_detection_info {
    int64_t timestamp;
    int64_t scene_index;
...
enum seccamera_ext_tags {
    ...
    SAMSUNG_ANDROID_CONTROL_AVAILABLE_BURST_SHOT_FPS,           // int32[]    Static meta
    ...
    SAMSUNG_ANDROID_CONTROL_EFFECT_AE_AVAILABLE_TARGET_FPS_RANGE,    // int32[]    Static meta
    SAMSUNG_ANDROID_CONTROL_FACTORY_DRAM_TEST_STATE,            // byte       Dynamic meta
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_AUTO_DETECT_REGIONS,  // int32[]    Control meta
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_MODE,             // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_TRIGGER,          // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_SUPER_SLOW_MOTION_STATE,            // int32       Dynamic meta
    SAMSUNG_ANDROID_CONTROL_BOKEH_BLUR_STRENGTH,                 // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_ZOOM_IN_OUT_PHOTO,                  // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_BOKEHSTATE,                         // int32       Dynamic meta
    SAMSUNG_ANDROID_CONTROL_DUAL_CAMERA_DISABLE,                // byte       Control meta
    SAMSUNG_ANDROID_CONTROL_BEAUTY_FACE_RETOUCH_LEVEL,          // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_REPEATING_REQUEST_HINT,             // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_LATEST_PREVIEW_TIMESTAMP,           // int64       Control meta
    SAMSUNG_ANDROID_CONTROL_BEAUTY_FACE_SKIN_COLOR_LEVEL,       // int32       Control meta
    SAMSUNG_ANDROID_CONTROL_SCENE_DETECTION_INFO,               // int64[]     Control meta
    SAMSUNG_ANDROID_CONTROL_STR_BV_OFFSET,                      // int32       Dynamic meta
    ...
    SAMSUNG_ANDROID_JPEG_AVAILABLE_THUMBNAIL_SIZES,             // int32[]    Static meta
    ...
    SAMSUNG_ANDROID_SCALER_AVAILABLE_PREVIEW_STREAM_CONFIGURATIONS,             // int32[]    Static meta
    SAMSUNG_ANDROID_SCALER_AVAILABLE_PICTURE_STREAM_CONFIGURATIONS,             // int32[]    Static meta
    ...
    SAMSUNG_ANDROID_SCALER_AVAILABLE_IRIS_STREAM_CONFIGURATIONS,                // int32[]    Static meta
    SAMSUNG_ANDROID_SCALER_AVAILABLE_MAX_DIGITAL_ZOOM,                          // float      Static meta
    ...
    SAMSUNG_ANDROID_SENSOR_MULTI_LUMINANCES,                    // int32[]    Dynamic meta
