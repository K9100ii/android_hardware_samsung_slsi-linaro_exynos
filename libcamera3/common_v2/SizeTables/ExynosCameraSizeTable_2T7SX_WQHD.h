...
#ifndef EXYNOS_CAMERA_LUT_2T7SX_H
#define EXYNOS_CAMERA_LUT_2T7SX_H
...
static int PREVIEW_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int DUAL_PREVIEW_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int PREVIEW_SIZE_LUT_2T7SX_BNS[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.5
       BDS       = 1440p */
...
static int PICTURE_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = OFF */
...
static int VIDEO_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1440p */
...
static int VIDEO_SIZE_LUT_120FPS_HIGH_SPEED_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_240FPS_HIGH_SPEED_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VIDEO_SIZE_LUT_SSM_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = ON
       BNS ratio = 1.0
       BDS       = ON */
...
static int VTCALL_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = 2
       BNS ratio = 1.0
       BDS       = ON */
...
static int FAST_AE_STABLE_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = ON
...
static int PREVIEW_FULL_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int PICTURE_FULL_SIZE_LUT_2T7SX[][SIZE_OF_LUT] =
{
    /* Binning   = OFF
       BNS ratio = 1.0
       BDS       = 1080p */
...
static int SAK2T7SX_YUV_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 5184, 3880, 33331760, SIZE_RATIO_4_3},
...
static int SAK2T7SX_JPEG_LIST[][SIZE_OF_RESOLUTION] =
{
    /* { width, height, minFrameDuration, ratioId } */
    { 5184, 3880, 33331760, SIZE_RATIO_4_3},
...
static int SAK2T7SX_HIDDEN_PREVIEW_SIZE_LIST[][SIZE_OF_RESOLUTION] =
{
...
static int SAK2T7SX_HIDDEN_PICTURE_SIZE_LIST[][SIZE_OF_RESOLUTION] =
{
    { 4032, 1960, 50000000, SIZE_RATIO_18P5_9},
};

/* For HAL3 */
static int SAK2T7SX_HIGH_SPEED_VIDEO_LIST[][SIZE_OF_RESOLUTION] =
{
    { 1920,  1080, 0, SIZE_RATIO_16_9},
    { 1280,   720, 0, SIZE_RATIO_16_9},
};

static int SAK2T7SX_FPS_RANGE_LIST[][2] =
{
    {  15000,  15000},
    {  10000,  24000},
    {  24000,  24000},
...
/* For HAL3 */
static int SAK2T7SX_HIGH_SPEED_VIDEO_FPS_RANGE_LIST[][2] =
{
    {  30000, 120000},
    {  60000, 120000},
    { 120000, 120000},
...
static int SAK2T7SX_AVAILABLE_VIDEO_LIST[][7] =
{
...
static int SAK2T7SX_AVAILABLE_HIGH_SPEED_VIDEO_LIST[][5] =
{
...
/* effect fps range */
static int SAK2T7SX_EFFECT_FPS_RANGE_LIST[][2] =
{
    {  10000,  24000},
    {  24000,  24000},
};

static camera_metadata_rational COLOR_MATRIX1_2T7SX_3X3[] =
{
...
static camera_metadata_rational COLOR_MATRIX2_2T7SX_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX1_2T7SX_3X3[] =
{
...
static camera_metadata_rational FORWARD_MATRIX2_2T7SX_3X3[] =
{
