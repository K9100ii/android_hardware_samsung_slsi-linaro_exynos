...
uint32_t drm_fourcc_from_handle(const private_handle_t *hnd)
{
	...
	static table_entry table[] = {
		...
		{ HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_P_M, DRM_FORMAT_YUV420 },
		...
		{ HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_P,          DRM_FORMAT_YUV420 },
...
#if 0
// TODO: check if AFBC_FORMAT_MOD_SPARSE is not used in gralloc3
// or the ddk.
