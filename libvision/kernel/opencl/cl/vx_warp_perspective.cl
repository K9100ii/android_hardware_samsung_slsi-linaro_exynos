				  ...
				  int border_mode, int border_constant)
{
	...
	float z = pX * perspective[2] + pY * perspective[5] + perspective[8];
	float srcX = (pX * perspective[0] + pY * perspective[3] + perspective[6]) / z;
	float srcY = (pX * perspective[1] + pY * perspective[4] + perspective[7]) / z;
