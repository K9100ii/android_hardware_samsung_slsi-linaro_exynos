...
#ifndef EXYNOS_SCORE_KERNEL_AND_H
#define EXYNOS_SCORE_KERNEL_AND_H
...
class ExynosScoreKernelAnd : public ExynosScoreKernel {
private:
    ScBuffer*    m_in_buf1;
    ScBuffer*    m_in_buf2;
    ScBuffer*    m_out_buf;
...
public:
    /* Contructor */
    ExynosScoreKernelAnd(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosScoreKernelAnd();
