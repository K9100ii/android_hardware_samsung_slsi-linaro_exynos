...
#ifndef EXYNOS_SCORE_KERNEL_CANNYEDGE_H
#define EXYNOS_SCORE_KERNEL_CANNYEDGE_H
...
class ExynosScoreKernelCannyEdge : public ExynosScoreKernel {
private:
    ScBuffer*    m_in_buf;
    ScBuffer*    m_out_buf;
    sc_enum_e    m_norm;
...
public:
    /* Contructor */
    ExynosScoreKernelCannyEdge(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosScoreKernelCannyEdge();
