...
#ifndef EXYNOS_SCORE_KERNEL_CONVOLUTION_H
#define EXYNOS_SCORE_KERNEL_CONVOLUTION_H
...
class ExynosScoreKernelConvolution : public ExynosScoreKernel {
private:
    ScBuffer*    m_in_buf;
    ScBuffer*    m_conv_buf;
    ScBuffer*    m_out_buf;
    sc_u32       m_kernel_size;
    sc_s32       m_norm;
...
public:
    /* Contructor */
    ExynosScoreKernelConvolution(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosScoreKernelConvolution();
