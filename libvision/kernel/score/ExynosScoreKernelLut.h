...
#ifndef EXYNOS_SCORE_KERNEL_LUT_H
#define EXYNOS_SCORE_KERNEL_LUT_H
...
class ExynosScoreKernelLut : public ExynosScoreKernel {
private:
    ScBuffer*    m_in_buf;
    ScBuffer*    m_lut_buf;
    ScBuffer*    m_out_buf;
...
public:
    /* Contructor */
    ExynosScoreKernelLut(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosScoreKernelLut();
