...
#ifndef EXYNOS_VPU_KERNEL_ABSDIFF_H
#define EXYNOS_VPU_KERNEL_ABSDIFF_H
...
class ExynosVpuKernelAbsDiff : public ExynosVpuKernel {
private:
    vx_df_image m_image_format;
...
public:
    /* Contructor */
    ExynosVpuKernelAbsDiff(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelAbsDiff();
