...
#ifndef EXYNOS_VPU_KERNEL_ACCUM_H
#define EXYNOS_VPU_KERNEL_ACCUM_H
...
class ExynosVpuKernelAccum : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelAccum(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelAccum();
