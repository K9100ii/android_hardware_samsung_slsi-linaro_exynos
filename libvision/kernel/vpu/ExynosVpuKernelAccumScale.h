...
#ifndef EXYNOS_VPU_KERNEL_ACCUMSCALE_H
#define EXYNOS_VPU_KERNEL_ACCUMSCALE_H
...
class ExynosVpuKernelAccumScale : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelAccumScale(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelAccumScale();

    static vx_status outputValidator(vx_node node, vx_uint32 index, vx_meta_format meta);
};

class ExynosVpuKernelAccumWeighted : public ExynosVpuKernelAccumScale {
private:
...
public:
    /* Constructor */
    ExynosVpuKernelAccumWeighted(vx_char *name, vx_uint32 param_num);

    static vx_status inputValidator(vx_node node, vx_uint32 index);

};

class ExynosVpuKernelAccumSquare : public ExynosVpuKernelAccumScale {
private:
...
public:
    /* Constructor */
    ExynosVpuKernelAccumSquare(vx_char *name, vx_uint32 param_num);
