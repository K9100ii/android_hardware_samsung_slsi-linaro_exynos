...
#ifndef EXYNOS_VPU_KERNEL_ARITHMETIC_H
#define EXYNOS_VPU_KERNEL_ARITHMETIC_H
...
class ExynosVpuKernelArithmetic : public ExynosVpuKernel {
private:
...
public:
    /* For vpu drvier interface test */
    ExynosVpuKernelArithmetic(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelArithmetic();
...
class ExynosVpuKernelAdd : public ExynosVpuKernelArithmetic {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelAdd(vx_char *name, vx_uint32 param_num);
};

class ExynosVpuKernelSubtract : public ExynosVpuKernelArithmetic {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelSubtract(vx_char *name, vx_uint32 param_num);
};
