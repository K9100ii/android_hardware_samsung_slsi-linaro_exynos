...
#ifndef EXYNOS_VPU_KERNEL_BITWISEAND_H
#define EXYNOS_VPU_KERNEL_BITWISEAND_H
...
class ExynosVpuKernelBitwiseBinary : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseBinary(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelBitwiseBinary();
...
class ExynosVpuKernelBitwiseAnd : public ExynosVpuKernelBitwiseBinary {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseAnd(vx_char *name, vx_uint32 param_num);
};

class ExynosVpuKernelBitwiseOr : public ExynosVpuKernelBitwiseBinary {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseOr(vx_char *name, vx_uint32 param_num);
};

class ExynosVpuKernelBitwiseXor : public ExynosVpuKernelBitwiseBinary {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseXor(vx_char *name, vx_uint32 param_num);
};
