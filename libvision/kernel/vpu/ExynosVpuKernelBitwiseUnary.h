...
#ifndef EXYNOS_VPU_KERNEL_BITWISEUNARY_H
#define EXYNOS_VPU_KERNEL_BITWISEUNARY_H
...
class ExynosVpuKernelBitwiseUnary : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseUnary(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelBitwiseUnary();
...
class ExynosVpuKernelBitwiseNot : public ExynosVpuKernelBitwiseUnary {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelBitwiseNot(vx_char *name, vx_uint32 param_num);
};
