...
#ifndef EXYNOS_VPU_KERNEL_CANNYEDGE_H
#define EXYNOS_VPU_KERNEL_CANNYEDGE_H
...
class ExynosVpuKernelCannyEdge : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelCannyEdge(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelCannyEdge();
