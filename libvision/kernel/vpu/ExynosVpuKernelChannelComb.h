...
#ifndef EXYNOS_VPU_KERNEL_CHANNELCOMB_H
#define EXYNOS_VPU_KERNEL_CHANNELCOMB_H
...
class ExynosVpuKernelChannelComb : public ExynosVpuKernel {
private:
...
private:
    ...
    vx_status setPreChCombPu(ExynosVpuSubchainHw *subchain,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_in_pu_list,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_out_pu_list);
    vx_status setMainChCombPu(ExynosVpuSubchainHw *subchain,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *in_pu_list,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_out_pu_list);
    vx_status setPostChCombPu(ExynosVpuSubchainHw *subchain,
                                                Vector<pair<ExynosVpuPu*, vx_uint32>> *in_pu_list,
                                                Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_out_pu_list);

public:
    /* Contructor */
    ExynosVpuKernelChannelComb(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelChannelComb();
