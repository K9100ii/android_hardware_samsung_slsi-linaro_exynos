...
#ifndef EXYNOS_VPU_KERNEL_CHANNELEXTRACT_H
#define EXYNOS_VPU_KERNEL_CHANNELEXTRACT_H
...
class ExynosVpuKernelChannelExtract : public ExynosVpuKernel {
private:
    vx_df_image_e m_src_format;

    vx_enum m_channel;

    vx_bool m_src_mem_continuous;
    vx_uint32 m_src_plane;
...
private:
    ...
    vx_status setPreChExtractPu(ExynosVpuSubchainHw *subchain,
    ...
    vx_status setMainChExtractPu(ExynosVpuSubchainHw *subchain,
                                                    ExynosVpuIoSizeInout *std_size,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *in_pu_list,
                                                    Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_out_pu_list);
    vx_status setPostChExtractPu(ExynosVpuSubchainHw *subchain,
                                                ExynosVpuIoSizeInout *std_size,
                                                Vector<pair<ExynosVpuPu*, vx_uint32>> *in_pu_list,
                                                Vector<pair<ExynosVpuPu*, vx_uint32>> *ret_out_pu_list);
...
public:
    /* Contructor */
    ExynosVpuKernelChannelExtract(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelChannelExtract();
