...
#ifndef EXYNOS_VPU_KERNEL_CONVERTDEPTH_H
#define EXYNOS_VPU_KERNEL_CONVERTDEPTH_H
...
class ExynosVpuKernelConvertDepth : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelConvertDepth(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelConvertDepth();
