...
#ifndef EXYNOS_VPU_KERNEL_PHASE_H
#define EXYNOS_VPU_KERNEL_PHASE_H
...
class ExynosVpuKernelConvolution : public ExynosVpuKernel {
private:
    vx_int16 m_coff_array[VX_INT_MAX_CONVOLUTION_DIM*VX_INT_MAX_CONVOLUTION_DIM];
...
public:
    /* Contructor */
    ExynosVpuKernelConvolution(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelConvolution();
