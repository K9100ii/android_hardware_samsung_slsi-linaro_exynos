...
#ifndef EXYNOS_VPU_KERNEL_DILATE_H
#define EXYNOS_VPU_KERNEL_DILATE_H
...
class ExynosVpuKernelDilate : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelDilate(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelDilate();
