...
#ifndef EXYNOS_VPU_KERNEL_ERODE_H
#define EXYNOS_VPU_KERNEL_ERODE_H
...
class ExynosVpuKernelErode : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelErode(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelErode();
