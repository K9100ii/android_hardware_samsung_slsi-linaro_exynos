...
#ifndef EXYNOS_VPU_KERNEL_HALFGAUSSIAN_H
#define EXYNOS_VPU_KERNEL_HALFGAUSSIAN_H
...
class ExynosVpuKernelHalfScaleGaussian : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelHalfScaleGaussian(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelHalfScaleGaussian();
