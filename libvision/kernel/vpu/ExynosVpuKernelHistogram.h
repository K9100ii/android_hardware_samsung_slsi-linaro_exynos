...
#ifndef EXYNOS_VPU_KERNEL_HISTOGRAM_H
#define EXYNOS_VPU_KERNEL_HISTOGRAM_H
...
class ExynosVpuKernelHistogram : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelHistogram(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelHistogram();
...
class ExynosVpuTaskIfWrapperHistogram : public ExynosVpuTaskIfWrapper {
private:
...
public:
    ExynosVpuTaskIfWrapperHistogram(ExynosVpuKernelHistogram *kernel, vx_uint32 task_index);
};
