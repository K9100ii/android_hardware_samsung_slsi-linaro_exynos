...
#ifndef EXYNOS_VPU_KERNEL_MAGNITUDE_H
#define EXYNOS_VPU_KERNEL_MAGNITUDE_H
...
class ExynosVpuKernelMagnitude : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelMagnitude(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelMagnitude();
