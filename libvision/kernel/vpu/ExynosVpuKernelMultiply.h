...
#ifndef EXYNOS_VPU_KERNEL_MULTIPLY_H
#define EXYNOS_VPU_KERNEL_MULTIPLY_H
...
class ExynosVpuKernelMultiply : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelMultiply(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelMultiply();
