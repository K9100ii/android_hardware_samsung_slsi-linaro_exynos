...
#ifndef EXYNOS_VPU_KERNEL_PYRAMID_H
#define EXYNOS_VPU_KERNEL_PYRAMID_H
...
class ExynosVpuKernelPyramid : public ExynosVpuKernel {
private:
    vx_float32 m_pyramid_scale;
    vx_size m_out_pyramid_level;
...
private:
    ...
    ExynosVpuTaskIf* initTask0FromApiForHalfScale(vx_uint32 task_index, vx_uint32 pyramid_level);
    ExynosVpuTaskIf* initTasknFromApiForHalfScale(vx_uint32 task_index, vx_uint32 pyramid_level);
    ExynosVpuTaskIf* initTask0FromApiForORBScale(vx_uint32 task_index, vx_uint32 pyramid_level);
    ExynosVpuTaskIf* initTasknFromApiForORBScale(vx_uint32 task_index, vx_uint32 pyramid_level);

public:
    /* Contructor */
    ExynosVpuKernelPyramid(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelPyramid();
