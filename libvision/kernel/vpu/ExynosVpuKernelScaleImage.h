...
#ifndef EXYNOS_VPU_KERNEL_SCALEIMAGE_H
#define EXYNOS_VPU_KERNEL_SCALEIMAGE_H
...
class ExynosVpuKernelScaleImage : public ExynosVpuKernel {
private:
    vx_uint32 m_src_width, m_src_height;
    vx_uint32 m_dst_width, m_dst_height;

    vx_bool m_down_scaling;
...
public:
    /* Contructor */
    ExynosVpuKernelScaleImage(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelScaleImage();
