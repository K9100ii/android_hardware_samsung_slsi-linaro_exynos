...
#ifndef EXYNOS_VPU_KERNEL_SOBEL_H
#define EXYNOS_VPU_KERNEL_SOBEL_H
...
class ExynosVpuKernelSobel : public ExynosVpuKernel {
private:
    vx_bool m_gradient_x_enable;
    vx_bool m_gradient_y_enable;
...
public:
    /* Contructor */
    ExynosVpuKernelSobel(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelSobel();
