...
#ifndef EXYNOS_VPU_KERNEL_THRESHOLD_H
#define EXYNOS_VPU_KERNEL_THRESHOLD_H
...
class ExynosVpuKernelThreshold : public ExynosVpuKernel {
private:
...
public:
    /* Contructor */
    ExynosVpuKernelThreshold(vx_char *name, vx_uint32 param_num);

    /* Destructor */
    virtual ~ExynosVpuKernelThreshold();
