...
class KeyMintAidlTestBase : public ::testing::TestWithParam<string> {
  public:
    ...
    ErrorCode ImportKey(const AuthorizationSet& key_desc,
    ...
    /* for deviceLocked() test */
    ErrorCode Begin(KeyPurpose purpose,
    ...
    /* for deviceLocked() test */
    std::tuple<ErrorCode, string> ProcessMessage(const vector<uint8_t>& key_blob,
    ...
    static vector<string> build_params() {
        ...
        params.push_back("android.hardware.security.keymint.IKeyMintDevice/strongbox");
        return params;
    }
