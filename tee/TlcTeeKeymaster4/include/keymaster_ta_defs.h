/*
 * Copyright (C) 2014-2020 The Android Open Source Project
 *
...
/* Originally from AOSP: hardware/keymaster_defs.h
 * Modified by Trustonic. */

#ifndef KEYMASTER_TA_DEFS_H
#define KEYMASTER_TA_DEFS_H
...
/* Note, implementer's namespace for tags starts at 10000. */
typedef enum {
    ...
    KM_TAG_ROLLBACK_RESISTANCE = KM_BOOL | 303,   /* Whether key is rollback-resistant.  Specified
     ...
     */
    KM_TAG_EARLY_BOOT_ONLY = KM_ENUM | 305,
    ...
    KM_TAG_USER_ID = KM_UINT | 501,             /* Android ID of authorized user or authenticator(s) */
    ...
    KM_TAG_UNLOCKED_DEVICE_REQUIRED = KM_BOOL | 509, /* Require the device screen to be unlocked if
                                                      * the key is used. */
    ...
    KM_TAG_ATTESTATION_ID_DEVICE = KM_BYTES | 711, /* Used to provide the device's device name to be
                                                      included in attestation */
    KM_TAG_ATTESTATION_ID_PRODUCT = KM_BYTES | 712, /* Used to provide the device's product name to be
                                                      included in attestation */
    KM_TAG_ATTESTATION_ID_SERIAL = KM_BYTES | 713, /* Used to provide the device's serial number to be
                                                      included in attestation */
    KM_TAG_ATTESTATION_ID_IMEI = KM_BYTES | 714,   /* Used to provide the device's IMEI to be included
                                                      in attestation */
    KM_TAG_ATTESTATION_ID_MEID = KM_BYTES | 715,   /* Used to provide the device's MEID to be included
                                                      in attestation */
    KM_TAG_ATTESTATION_ID_MANUFACTURER = KM_BYTES | 716, /* Used to provide the device's manufacturer
